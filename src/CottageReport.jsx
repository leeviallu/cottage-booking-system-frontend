...

            {
                reservations[0] && cottages[0] ?
                    <div className='item-container'>
                        <h2>{cottages[0].area.name} palvelu raportti välillä {new Date(startDate).getDate()+'.'+(new Date(startDate).getMonth() + 1)+'.'+new Date(startDate).getFullYear()} - {new Date(endDate).getDate()+'.'+(new Date(endDate).getMonth() + 1)+'.'+new Date(endDate).getFullYear()}</h2>
